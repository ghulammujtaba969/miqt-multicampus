...
// Build query for Alumni (support both 'alumni' and legacy 'graduated')
$where = "WHERE s.status IN ('alumni','graduated')";
$params = [];
...
<div class="page-header">
    <h1 class="page-title"><i class="fas fa-user-graduate"></i> Alumni</h1>
    <p class="subtitle">Total Alumni: <?php echo $total; ?></p>
...
<div class="dashboard-card">
    <div class="card-body">
        ...
        <?php else: ?>
        <p class="text-center text-muted">No alumni found</p>
        <?php endif; ?>
    </div>
</div>
